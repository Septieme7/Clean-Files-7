...
// showMissingSoftwareModal removed — server conversion features disabled.

// hideMissingSoftwareModal removed — no-op (server conversion disabled)

/**
 * Envoie les fichiers nettoyés au serveur pour création d'une archive 7z
 * @param {string} serverUrl - URL du endpoint serveur
 */
// sendFilesToServerFor7z removed — server conversion disabled
 ...
 */
// checkServerRoot removed — no longer required
 ...
 */
// checkServer7z removed — server check not used
...
function setupArchiveModal() {
    ...
    // Server conversion UI removed — nothing to bind here
...
// Duplicate utility block removed — utilities are defined earlier in the file.
